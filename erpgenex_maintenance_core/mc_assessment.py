...
from erpgenex_maintenance_core.mc_gap_register import get_gap_status
from erpgenex_maintenance_core.mc_global_benchmark import get_global_mc_score

@frappe.whitelist()
def export_mc_global_audit() -> dict:
	root = os.path.join(get_bench_path(), "Docs", "2026-06-06_ERPGENEX_MAINTENANCE_CORE_GLOBAL_AUDIT")
	os.makedirs(root, exist_ok=True)
	score, gaps = get_global_mc_score(), get_gap_status()
